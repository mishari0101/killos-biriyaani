...
export function BranchDeleteModal({ item, deleting, onCancel, onConfirm }: BranchDeleteModalProps) {
  return (
    <div
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="mt-1.5 text-[0.85rem] leading-relaxed text-[var(--admin-fg-soft)]">
                  ...
                  will be removed from the branches, location, contact and footer sections. Any
                  uploaded photo is deleted too. This cannot be undone.
                </p>
              </div>
            </div>
