...
interface ContactMessageNotesModalProps {
...
export function ContactMessageNotesModal({
  item,
  saving,
  onCancel,
  onSave,
}: ContactMessageNotesModalProps) {
        ...
        <div className="admin-card overflow-hidden">
          <div className="px-6 py-6 sm:px-7">
            <div className="flex items-start justify-between gap-4">
              <div>
                ...
                <p className="mt-1.5 text-[0.85rem] leading-relaxed text-[var(--admin-fg-soft)]">
                  ...
                  — {item.name} about &ldquo;{item.subject}&rdquo;. These notes are only visible
                  to staff.
                </p>
              </div>
            ...
            <div className="mt-5 flex flex-col gap-1.5">
              <label htmlFor="contact-message-notes" className="admin-field-label">
                Notes
              </label>
              <textarea
                ...
                placeholder="Anything the team should know — follow-up, priority, contact method…"
                maxLength={MAX_NOTES}
                rows={5}
                autoFocus
