...
interface ContactMessageDeleteModalProps {
...
export function ContactMessageDeleteModal({
  item,
  deleting,
  onCancel,
  onConfirm,
}: ContactMessageDeleteModalProps) {
  return (
    <div
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="mt-1.5 text-[0.85rem] leading-relaxed text-[var(--admin-fg-soft)]">
                  ...
                  from {item.name} will be permanently removed. This cannot be undone.
                </p>
              </div>
            </div>

            <div className="mt-5 rounded-xl border border-[var(--admin-border)] bg-[var(--admin-field-bg)] p-4">
              <p className="text-[0.82rem] font-semibold text-[var(--admin-fg)]">
                {item.subject}
              </p>
