...
import { AlertCircleIcon, ImageIcon, TrashIcon } from "@/components/ui/icons";
...
export function GalleryDeleteModal({ item, deleting, onCancel, onConfirm }: GalleryDeleteModalProps) {
  return (
    <div
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="mt-1.5 text-[0.85rem] leading-relaxed text-[var(--admin-fg-soft)]">
                  <strong className="font-semibold text-[var(--admin-fg)]">{item.title}</strong>{" "}
                  and its uploaded image will be permanently removed from the gallery. This cannot
                  be undone.
                </p>
              </div>
            </div>
