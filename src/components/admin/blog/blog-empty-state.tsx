...
import { PenLineIcon, PlusIcon, RefreshIcon } from "@/components/ui/icons";
...
export function BlogEmptyState({ hasFilters, onAdd, onClear }: BlogEmptyStateProps) {
  return (
    <div className="admin-card overflow-hidden">
      <div className="admin-placeholder-grid relative flex flex-col items-center justify-center px-6 py-20 text-center">
        ...
        <p className="relative mt-2 max-w-md text-[0.85rem] leading-relaxed text-[var(--admin-fg-soft)]">
          {hasFilters
            ? "Try clearing your filters or search to see every post."
            : "Write your first article — share news, offers and stories with your guests. Drafts stay hidden until you publish them."}
        </p>
