...
import { MapPinIcon, PlusIcon, RefreshIcon } from "@/components/ui/icons";
...
export function AttractionEmptyState({ hasFilters, onAdd, onClear }: AttractionEmptyStateProps) {
  return (
    <div className="admin-card overflow-hidden">
      <div className="admin-placeholder-grid relative flex flex-col items-center justify-center px-6 py-20 text-center">
        ...
        <h2 className="relative mt-6 font-serif text-xl font-semibold text-[var(--admin-fg)]">
          {hasFilters ? "No matching attractions" : "No attractions yet"}
        </h2>
        <p className="relative mt-2 max-w-md text-[0.85rem] leading-relaxed text-[var(--admin-fg-soft)]">
          {hasFilters
            ? "Try clearing your filters or search to see every attraction."
            : "Add your first nearby spot to build the travel section guests see."}
        </p>
